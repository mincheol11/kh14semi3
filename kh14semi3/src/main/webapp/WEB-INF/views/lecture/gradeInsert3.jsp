    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.grade-save-btn', function() {
                ...
                console.log(gradeScore1);
                console.log(gradeScore2);
                console.log(gradeHomework);
                
                console.log(gradeRank);
                ...
                <tbody align="center">
                    <c:forEach var="gradeStudentVO" items="${studentList}">
                        <tr data-grade-code="${gradeStudentVO.gradeCode}" data-member-id="${gradeStudentVO.memberId}">
                            ...
                            <td><button type="button" class="btn btn-neutral grade-input-btn">입력</button></td>
                            <td><button type="button" class="btn btn-positive grade-save-btn" disabled>저장</button></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
